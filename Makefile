...
lint:  ## run static analysis with flake8
	python -m black --check stixx/game.py
...
test: ## clean and run unit tests
	python -m pytest -v stixx/tests

coverage:  ## clean and run unit tests with coverage
	python -m pytest -v stixx/tests --cov=stixx --cov-branch --cov-fail-under=70 --cov-report term-missing
